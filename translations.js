var T = {
  fr: {
    ...
    hhDossier:'Dossier ↕', hhDateCaisse:'Date de Caisse ↕', hhDate:'Date ↕', hhTime:'Heure ↕', hhProduct:'Produit ↕',
    hhDose:'Dose ↕', hhFormat:'Format ↕', hhUnitPrice:'Prix/u ↕', hhQty:'Qté ↕',
    hhTotal:'Total ↕', hhForfait:'Forfaitaire ↕',
    histSearchPlaceholder:'Rechercher (dossier, produit, dose, format)...',
    btnHistMore:'Charger le jour précédent',
    ...
    toastOverStock:'La quantité demandée dépasse le stock disponible.',
  ...
  en: {
    ...
    lblHistTo:'To:',
    btnHistClear:'✕ Reset',
    hhDossier:'File No. ↕', hhDateCaisse:'Accounting Day ↕', hhDate:'Date ↕', hhTime:'Time ↕', hhProduct:'Product ↕',
    hhDose:'Dose ↕', hhFormat:'Format ↕', hhUnitPrice:'Price/u ↕', hhQty:'Qty ↕',
    hhTotal:'Total ↕', hhForfait:'Forfaitaire ↕',
    histSearchPlaceholder:'Search (file no, product, dose, format)...',
    btnHistMore:'Load previous day',
    ...
    toastOverStock:'The requested quantity exceeds the available stock.',
